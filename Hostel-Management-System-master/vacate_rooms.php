	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home.php"> <span class="display"> GMIT</span></a></h1>
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					...
					<li class="dropdown nav-item"></li>
						...
						<li><a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">Rooms
							<b class="caret"></b>
						</a>
...
if(isset($_POST['submit'])){
    ...
    $query2 = "SELECT * FROM APPLICATION  WHERE Hostel_name = '$hostel' and Room_id = '$room_number'";
