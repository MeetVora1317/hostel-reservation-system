	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home.php">GMIT <span class="display"></span></a></h1>
   ...
   if(isset($_POST['submit'])){
     ...
     if($row = mysqli_fetch_assoc($result)){
        ...
        if($pwdCheck == false){
            ...
            $query3 = "INSERT INTO Application (Student_id,Hostel_id,Hostle_name,Application_status,Message) VALUES ('$roll','$hostel_id','$hostelname',true,'$message')";
