...
<body>
    ...
    <div class=" w3l-login-form">
        ...
        <form action="includes/login.inc.php" method="POST">
          ...
          <p class=" w3l-register-p">Login as<a href="login-hostel_admin.php" class="register"> Admin </a> | <a href = "Hostel_manager-login.php" class = "register">  HostelManager </a>| <a href = "pparentloging.php" class = "register">  Parents </a></p>
