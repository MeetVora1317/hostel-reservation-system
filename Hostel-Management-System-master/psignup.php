...
<body>
    ...
    <div class=" w3l-login-form">
        <h2>Sign Up Here</h2>
        <form action="includes/ppsignup.inc.php" method="POST">

            <div class=" w3l-form-group">
                <label>parents id</label>
                <div class="group">
                    <i class="fas fa-id-badge"></i>
                    <input type="text" class="form-control" name="roll_no" placeholder="Roll No" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="p_fname" placeholder="First Name" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    <i class="fas fa-user"></i>
                    <input type="text" class="form-control" name="p_lname" placeholder="Last Name" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
          ...
          <!--  <div class=" w3l-form-group">
            ...
            <button type="submit" name="signup-submit">Sign Up</button></div>div>
        </form>
